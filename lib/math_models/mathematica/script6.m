...
scale = Read[StringToStream[$ScriptCommandLine[[11]]], Number];
...
retval = SampleTenParamFunction[pidTPPdata,gamma1, gamPID1, strain, zoff1, gamPID2, frac1, zoff2, aHex, cHex, 0.000006313];
Print[retval];
